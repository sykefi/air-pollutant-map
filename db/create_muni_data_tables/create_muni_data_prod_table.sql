...
-- group muni data (master) by prod gnfr names -> create a temporary tables
...
CREATE TABLE public.muni_data_gnfr_prod AS (
  SELECT vuosi, MD_GROUPS.kuntanro, K45.geom, K100.shape_star as area, gnfr_prod as gnfr,s16,s15,s22,s13,s28,s29,s27,s43,s5,s18,s3,s12,s1,s7,s8,s14,s37,s25,s19,s17,s38,s40
